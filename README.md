...
Plane And Simple is a demo for Atari ST by the MegaBuSTers,
scheduled for release in 2025.

The initial goal is to play with simple demos, using
bit planes for transparency and adjacency effects
